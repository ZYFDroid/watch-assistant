...
//hooks
	...
	public void showHelp(String text,String flag){
		...
		if(loadstate("help_" +helpflag).isEmpty()){
			new AlertDialog.Builder(this).setTitle("提示").setMessage(text).setPositiveButton("确定", null).setNegativeButton("不再提示", new DialogInterface.OnClickListener(){
...
public static void syso(Object p1){
	android.util.Log.d("com.tomoon.extensions.bluessh",p1.toString());
	Klog.v(p1);
}
